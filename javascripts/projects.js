...
interpolate: true
---
function getCorrectUrl(linkUrl, path) {
  console.log("linkUrl:" + linkUrl + " path:" + path);
  if (path) {
    if (path.contains(linkUrl)) {
      if (path.contains('http')) > 0) {
        return path;
      } else {
        return "https://" + linkUrl + ".jboss.org" + path.split(linkUrl)[1];
      }
    } else {
      return "https://" + linkUrl + ".jboss.org" + path;
    }
  }
      ...
      for (var i = 0; i < hits.length; i++) {
        ...
        if (props.downloadsLink) {
          template += "<a class=\"upstream-download\" href=\""
            + getCorrectUrl(props.sys_url_view, props.downloadsLink) + "\"><i class=\"fa fa-download\"></i> Download</a>";
        }
        ...
        if (props.docsLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.docsLink) + "\">Documentation</a></li>";
        }
        if (props.communityLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.communityLink) + "\">Community</a></li>";
        }
        if (props.knowledgeBaseLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.knowledgeBaseLink) + "\">KnowledgeBase</a></li>";
        }
        if (props.userForumLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.userForumLink) + "\">User Forum</a></li>";
        }
        if (props.devForumLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.devForumLink) + "\">Dev Forum</a></li>";
        }
        if (props.mailingListLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.mailingListLink) + "\">Mailing List</a></li>";
        }
        if (props.chatLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.chatLink) + "\">Chat</a></li>";
        }
        if (props.blogLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.blogLink) + "\">Blog</a></li>";
        }
        if (props.twitterLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.twitterLink) + "\">Twitter</a></li>";
        }
        if (props.issueTrackerLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.issueTrackerLink) + "\">Issue Tracker</a></li>";
        }
        if (props.jiraLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.jiraLink) + "\">JIRA</a></li>";
        }
        if (props.srcLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.srcLink) + "\">Source</a></li>";
        }
        if (props.anonymousLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.anonymousLink) + "\">Anonymous Source</a></li>";
        }
        if (props.commiterLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.commiterLink) + "\">Committer Source Access</a></li>";
        }
        if (props.fisheyeLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.fisheyeLink) + "\">FishEye</a></li>";
        }
        if (props.viewvcLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.viewvcLink) + "\">View Source</a></li>";
        }
        if (props.githubLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.githubLink) + "\">Github</a></li>";
        }
        if (props.anonymousGitLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.anonymousGitLink) + "\">Anonymous Git</a></li>";
        }
        if (props.committerGitLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.committerGitLink) + "\">Committer Git</a></li>";
        }
        if (props.buildLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.buildLink) + "\">Build</a></li>";
        }
        if (props.hudsonLink) {
          template += "<li><a href=\"" + getCorrectUrl(props.sys_url_view, props.hudsonLink) + "\">Jenkins</a></li>";
        }
