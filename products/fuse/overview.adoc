...
Leverage Apache Camel to provide a full-featured, easy-to-use and intuitive framework for quicker integration solutions. Seamlessly create API's.
...
Connect to external applications with connectors for JDBC, FTP/SFTP, HTTP/HTTPS, file, SalesForce.com, SAP, Twitter, and more. Quickly connect API's.
...
* API foundation – seamlessly create RESTful API's
